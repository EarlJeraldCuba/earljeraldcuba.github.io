var team = [
  ...
  },
  {
    ...
    title: "Software Developer",
    image: "images/team/tenorio.jpg",
    details:
      "She's currently in her 3rd year in college. She loves to code using HTML and CSS but still lacking in programming languages. She likes to  observe and learn from other people.",
  },
  {
...
function buildTeam() {
  ...
  for (var i = 0; team.length > i; i++) {
    var student = team[i];
    if (student.image != null && student.details != null) {
      var item = `
        <div class="student">
          <div class="img-cont">
            <div class="image"style="background-image: url(${student.image})"></div>
          </div>
